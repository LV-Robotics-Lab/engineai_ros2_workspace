...
def generate_launch_description():
    ...
    def launch_setup(context, *args, **kwargs):
        ...
        perturbation_node = Node(
            ...
            executable='perturbation_simulator',  # 可执行文件名
            name='perturbation_simulator',        # 节点名称
            output='screen',                      # 输出到终端
        ...
        # 返回节点对象列表
        return [perturbation_node, joint_state_converter_node, robot_state_publisher_node, static_transform_publisher_node]

    # 使用OpaqueFunction以便在launch时动态获取参数
    perturbation_launch = OpaqueFunction(function=launch_setup)
